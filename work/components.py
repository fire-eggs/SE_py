...
def init_components():
    ...
    ALL_COMPONENTS.extend([
        ...
        Component(1, "Ion Engine", "E", size=1, cost=100, tech=1),
        #Component(2, "Cargo Hold", "C", 2, 5, 1),
        Component(2, "Cargo Hold", "C", size=1, cost=15, tech=1),
        #Component(3, "Space Yard 1", "Y", 3, 50, 1, comp_type=1),
        Component(3, "Space Yard 1", "Y", 5, 300, 1, comp_type=1,rate=1),
        ...
        Component(26, "Outpost Module (1M)", "M", 5, 1000, 1),
        #Component(27, "Colony Module", "M", 5, 50, 5),
        Component(27, "Colony Module (50M)", "M", 10, 2500, 1),
        #Component(28, "Settlement Module", "M", 10, 150, 10),
        Component(28, "Settlement Module (200M)", "M", 15, 5000, 1),
        ...
        Component(40, "Mass Driver 1", "W", size=2, cost=75, tech=1, damage=2, range_val=2, decrease_dmg=0, rate=1, speed=1, fire_type=2),
        ...
        Component(44, "Phaser 1", "W", 3, 100, 1, damage=2, range_val=2, decrease_dmg=0.7,rate=0,speed=0,fire_type=1,comp_type=1),
